...
The article recommends a higher number of epochs (1000 - 4000) and neurons (1-5) for better results, but due to time and resource requirements of running forecasts for several hundered players, the 100 epochs and 1 neuron provided very good results in a less resource intensive manner.
