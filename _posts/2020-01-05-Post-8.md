...
All the code, data and associated files for the project can be accessed at my [GitHub][1].  The README file provides details of the repo directory and files.  The Web scraping and NLP were run using Jupyter Notebook.  The step  
