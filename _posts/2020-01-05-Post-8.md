...
[Flask][6] is a simple Python Web development framework that is ideal for small projects such as this.  This specifics of using Flask will not be covered in this article, however an overview of the code will be provided.  
