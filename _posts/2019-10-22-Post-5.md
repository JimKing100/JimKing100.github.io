...
### Step 2 - Initalize the ColorBar and Tools then Plot!
...
The ColorBar palette, HoverTool and TapTool are initialized and the make_plot function is called creating the initial plot showing the median price heatmap on the map and the datatable with the Bernal Heights data.  The HoverTool shows the neighborhood stats and the TapTool selects a neighborhood.  More details on the TapTool follow!
