...
The goal of the project is to predict the prices of a single-family homes in San Francisco in 2018 better than the baseline with a stretch goal of matchingor beating the Zillow metrics.
