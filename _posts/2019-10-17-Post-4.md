...
```
Finally, a new correlation matrix shows the resulting relationships of the new wrangled features.

![Correlation_Matrix_2](/img/jestimate/pearson_correlation_1.png)
