...
All the code, data and associated files for the project can be accessed at my [GitHub][4].  After installing Dash, run the code on your local computer from the the directory the code resides in and in your terminal run **python app.py**.  This will run the app on your local host (http://127.0.0.1:8050).  
