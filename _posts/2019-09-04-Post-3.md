...
All the code, data and associated files for the project can be accessed at my [GitHub](https://medium.com/r/?url=https%3A%2F%2Fgithub.com%2FJimKing100%2FSF_Real_Estate_Live). The final Colab code for running on the Bokeh server can be found here. A test version of the Colab code skipping the data cleaning and wrangling steps can be found here.
